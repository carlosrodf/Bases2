...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		// Usuario
		$this->Usuario = new crField('Report4', 'Report4', 'x_Usuario', 'Usuario', '`Usuario`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Establecimiento
		$this->Establecimiento = new crField('Report4', 'Report4', 'x_Establecimiento', 'Establecimiento', '`Establecimiento`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->Establecimiento->GroupingFieldId = 2;
		$this->Establecimiento->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		...
		// Accion
		$this->Accion = new crField('Report4', 'Report4', 'x_Accion', 'Accion', '`Accion`', 200, EWR_DATATYPE_STRING, -1);
		$this->fields['Accion'] = &$this->Accion;
		$this->Accion->DateFilter = "";
		$this->Accion->SqlSelect = "";
		$this->Accion->SqlOrderBy = "";

		// Fecha
		$this->Fecha = new crField('Report4', 'Report4', 'x_Fecha', 'Fecha', '`Fecha`', 135, EWR_DATATYPE_DATE, 5);
		...
		// Mensaje
		$this->Mensaje = new crField('Report4', 'Report4', 'x_Mensaje', 'Mensaje', '`Mensaje`', 200, EWR_DATATYPE_STRING, -1);
		$this->fields['Mensaje'] = &$this->Mensaje;
		$this->Mensaje->DateFilter = "";
		$this->Mensaje->SqlSelect = "";
		$this->Mensaje->SqlOrderBy = "";
	}
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`reporte4view`";
	}
	...
	function getSqlOrderBy() {
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`Usuario` ASC, `Establecimiento` ASC";
	}
