	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<div id="frptlogin_options" class="collapse">
					...
					<label for="type1"><input type="radio" name="type" id="type1" value="a"<?php if ($rptlogin->LoginType == "a") { ?> checked="checked"<?php } ?>><?php echo $ReportLanguage->Phrase("AutoLogin") ?></label>
					</div>
					<div class="radio ewRadio">
					<label for="type2"><input type="radio" name="type" id="type2" value="u"<?php if ($rptlogin->LoginType == "u") { ?>  checked="checked"<?php } ?>><?php echo $ReportLanguage->Phrase("SaveUserName") ?></label>
					</div>
		</div>
	</div>
	</div>
