...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		// Usuario
		$this->Usuario = new crField('Report1', 'Report1', 'x_Usuario', 'Usuario', '`Usuario`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Nombre
		$this->Nombre = new crField('Report1', 'Report1', 'x_Nombre', 'Nombre', '`Nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Establecimiento
		$this->Establecimiento = new crField('Report1', 'Report1', 'x_Establecimiento', 'Establecimiento', '`Establecimiento`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Oficial
		$this->Oficial = new crField('Report1', 'Report1', 'x_Oficial', 'Oficial', '`Oficial`', 200, EWR_DATATYPE_STRING, -1);
		$this->fields['Oficial'] = &$this->Oficial;
		$this->Oficial->DateFilter = "";
		$this->Oficial->SqlSelect = "SELECT DISTINCT `Oficial` FROM " . $this->getSqlFrom();
		$this->Oficial->SqlOrderBy = "`Oficial`";
	}
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`reporte1view`";
	}
	...
	function getSqlOrderBy() {
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`Usuario` ASC, `Nombre` ASC";
	}
